  ...
  return (
    <div className='main-div'>
      ...
      <div className='main-content fade-in animation-delay-06'>
        ...
        <br />
        <p className='fade-in animation-delay-09'>
          It is my passion to build web apps that are highly 
          <span className='text-emph'>usable</span>
          , functionally <span className='text-emph'>responsive</span>
          , fully <span className='text-emph'>accessible</span>
          , and flawlessly <span className='text-emph'>performable</span>.
        </p>
        <Link href='./projects' className='fade-in animation-delay-10'>
